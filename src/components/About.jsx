            ...
            <div className={`${darkMode ? 'dark' : 'bg-grey'}`} id='about'>
                <div className="flex flex-col py-10 gap-2 items-center">
                    <div className="flex gap-3">
                        ...
                        <p className="text-md font-light text-cinder-light dark:text-white tracking-widest font-inter">LEARNING PATH</p>
                    </div>
                    <p className="text-cinder-dark dark:text-cinder-dark-mode font-bold text-3xl font-pjs xl:ml-36">ABOUT & SKILLS</p>
                </div>

                <div className='flex flex-col md:flex-row md:gap-0 xl:flex-row justify-evenly items-center gap-20 pt-5 pb-20'>
                    <div>
                        <p className='xl:w-96 w-80 font-inter text-cinder-light dark:text-white leading-8'>
                    ...
                    <div className='grid grid-rows-3 grid-cols-3 gap-x-1 xl:gap-x-16 gap-y-16'>
                        ...
                        <div className='flex flex-col -mt-3 text-cinder-dark font-pjs items-center'>
