    ...
    <>
      ...
      >
        ...
        <div data-aos="zoom-in" data-aos-duration="800" data-aos-delay="500" className="flex flex-col gap-5 items-center text-center py-10 px-10 xl:px-72">
          ...
          <a href="mailto:edwindivine5@gmail.com"><button data-aos="fade-up" data-aos-duration="800" data-aos-delay="700" className="border rounded-md p-3 font-inter text-xl font-bold w-40 text-cinder-dark dark:text-cinder-dark-mode border-cinder-light shadow-xl shadow-gray-300 dark:shadow-black">Say Hello</button></a>
        </div>
      </section>
    </>
  );
